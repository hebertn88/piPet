      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="cores.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="table-responsive">
            ...
            <!-- Gerando novas cores -->
            <form action="gerarcores.php" method="post" enctype="multipart/form-data">
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
               <?php 
                $consulta = "SELECT * FROM cadastro_cor ORDER BY c_id ASC";
                $sql = $mysqli->query($consulta) or die($mysqli->error);
                while($dado = $sql->fetch_array())    
                {              
                ?> 
                <tr>
                  <td><?php echo $dado['c_id']; ?></td>
                  <td><?php echo $dado['c_cor']; ?></td>                  
                </tr>
                <?php } ?> 
              </tbody>
            </table>
